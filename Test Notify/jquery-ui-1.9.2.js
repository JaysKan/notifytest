    ...
    function (e, t) {
        ...
        e.widget("ui.dialog", {
            ...
            moveToTop: function (t, n) {
                //alert(e);
               // alert(e.ui.dialog.maxZ);
                //alert(this.uiDialog.css("z-index"));
                var r = this.options,
                    i;
                return r.modal && !t || !r.stack && !r.modal ? this._trigger("focus", n) : (r.zIndex > e.ui.dialog.maxZ && (e.ui.dialog.maxZ = r.zIndex), this.overlay && (e.ui.dialog.maxZ = 1001, e.ui.dialog.overlay.maxZ = e.ui.dialog.maxZ, this.overlay.$el.css("z-index", e.ui.dialog.overlay.maxZ)), i = {
                    scrollTop: this.element.scrollTop(),
                    scrollLeft: this.element.scrollLeft()
                }, e.ui.dialog.maxZ = 1002, this.uiDialog.css("z-index", e.ui.dialog.maxZ), this.element.attr(i), this._trigger("focus", n), this)
                //alert(this.uiDialog.css("z-index"));
            },
            open: function () {
                if (this._isOpen) return;
